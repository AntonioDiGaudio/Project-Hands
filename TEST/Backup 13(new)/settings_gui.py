...
class SettingsGUI:
    ...
    def update_slide_cooldown_time(self, val):
        ...
        """
        config.slide_cooldown_time = float(val) / 10  # Mappato da   a 0.1-1
    ...
    def update_zoom_max_distance(self, val):
        ...
        """
        config.zoom_max_distance = float(val) * 20  # Mappato da   a 20-200
...
zoom_threshold = 40
slide_cooldown_time = 0.01
zoom_max_distance = 160
zoom_cooldown_time = 0.2
...
"""
        ...
        try:
            ...
            self.sliders['slide_cooldown_time'].set(int(round(config.slide_cooldown_time / 0.01)))
    ...
    def show_info_popup(self):
        ...
        info_win.title("Istruzioni gesture e guida alle impostazioni di AirMouse")
        ...
        container = tk.Frame(info_win, bg=GUI_BG_COLOR)
        ...
        settings_info = {
            ...
            "Accelerazione hardware": "Se abilitato, utilizza l'accelerazione hardware (se supportata) per migliorare le prestazioni, ma può appesantire l'esecuzione del programma. In particolare delega il compito computazionale alla GPU, in questo momemnto è in fase Beta e non è del tutto implementat",
        ...
        tk.Button(scrollable_frame, text="Chiudi", command=info_win.destroy,
    ...
    def create_gui(self):
        ...
        make_scale('zoom_cooldown_time', 1, 10, 1, lambda v: self.update_zoom_cooldown_time(float(v)))
