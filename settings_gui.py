...
class SettingsGUI:
    ...
    def update_deadzone_threshold (self,val):
        """
        Aggiorna la zona morta.
        """
        config.deadzone_threshold  = float(val)
    ...
    def save_settings(self):
        ...
        with open(PROFILE_PATH, "w") as f:
            ...
            f.write(f"deadzone_threshold  = {config.deadzone_threshold }\n")
    ...
    def load_settings(self):
        ...
        try:
            ...
            config.deadzone_threshold  = float(values.get("deadzone_threshold", 5))
            ...
            self.sliders['deadzone_threshold'].set(int(round(config.deadzone_threshold)))
    ...
    def reset_values(self):
        ...
        self.update_deadzone_threshold(default_values['deadzone_threshold'])
        ...
        self.sliders['deadzone_threshold'].set(int(round(default_values['deadzone_threshold'])))
    ...
    def show_info_popup(self):
        ...
        info_consigli_text=(
            ...
            "Gesti della mano poco espliciti o ambigui possono intridurre lag a causa di difficoltà nel riconoscimento\n"
    ...
    def create_gui(self):
        ...
        make_label("Zona morta")
        make_scale('deadzone_threshold', 1, 10, 1, lambda v: self.update_deadzone_threshold(float(v)))
